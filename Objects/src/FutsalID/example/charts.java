...
public boolean IsInitialized;
public FutsalID.example.charts._graphinternal GI;
public String Title;
public String YAxis;
public String XAxis;
public float YStart;
...
public void Initialize() {
IsInitialized = true;
GI = new FutsalID.example.charts._graphinternal();
Title = "";
YAxis = "";
XAxis = "";
YStart = 0f;
...
public static String  _addbarcolor(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._bardata _bd,int _color) throws Exception{
...
public static String  _addbarpoint(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._bardata _bd,String _x,float[] _yarray) throws Exception{
FutsalID.example.charts._linepoint _b = null;
...
_b = new FutsalID.example.charts._linepoint();
...
public static String  _addlinecolor(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._linedata _ld,int _color) throws Exception{
...
public static String  _addlinemultiplepoints(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._linedata _ld,String _x,float[] _yarray,boolean _showtick) throws Exception{
FutsalID.example.charts._linepoint _p = null;
...
_p = new FutsalID.example.charts._linepoint();
...
public static String  _addlinepoint(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._linedata _ld,String _x,float _y,boolean _showtick) throws Exception{
FutsalID.example.charts._linepoint _p = null;
...
public static String  _addpieitem(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._piedata _pd,String _name,float _value,int _color) throws Exception{
FutsalID.example.charts._pieitem _i = null;
...
_i = new FutsalID.example.charts._pieitem();
...
public static int  _calcpointtopixel(anywheresoftware.b4a.BA _ba,float _py,FutsalID.example.charts._graph _g) throws Exception{
...
if (true) return (int) (_g.GI /*FutsalID.example.charts._graphinternal*/ .zeroY /*int*/ -(_g.GI /*FutsalID.example.charts._graphinternal*/ .originY /*int*/ -_g.GI /*FutsalID.example.charts._graphinternal*/ .maxY /*int*/ )*_py/(double)(_g.YEnd /*float*/ -_g.YStart /*float*/ ));
 }else {
 //BA.debugLineNum = 231;BA.debugLine="Return G.GI.originY - (G.GI.originY - G.GI.maxY)";
if (true) return (int) (_g.GI /*FutsalID.example.charts._graphinternal*/ .originY /*int*/ -(_g.GI /*FutsalID.example.charts._graphinternal*/ .originY /*int*/ -_g.GI /*FutsalID.example.charts._graphinternal*/ .maxY /*int*/ )*(_py-_g.YStart /*float*/ )/(double)(_g.YEnd /*float*/ -_g.YStart /*float*/ ));
 };
...
public static anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _createlegend(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._piedata _pd) throws Exception{
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmp = null;
float _textheight = 0f;
float _textwidth = 0f;
int _i = 0;
FutsalID.example.charts._pieitem _it = null;
...
_it = new FutsalID.example.charts._pieitem();
 //BA.debugLineNum = 312;BA.debugLine="it = PD.Items.Get(i)";
_it = (FutsalID.example.charts._pieitem)(_pd.Items /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
...
public static String  _drawbarschart(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._graph _g,FutsalID.example.charts._bardata _bd,int _backcolor) throws Exception{
FutsalID.example.charts._linepoint _point = null;
...
_point = new FutsalID.example.charts._linepoint();
 //BA.debugLineNum = 47;BA.debugLine="point = BD.Points.Get(1)";
_point = (FutsalID.example.charts._linepoint)(_bd.Points /*anywheresoftware.b4a.objects.collections.List*/ .Get((int) (1)));
...
_rect.Initialize((int) (0),(int) (0),(int) (0),_g.GI /*FutsalID.example.charts._graphinternal*/ .originY /*int*/ );
...
_point = (FutsalID.example.charts._linepoint)(_bd.Points /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
...
_rect.setLeft((int) (_g.GI /*FutsalID.example.charts._graphinternal*/ .originX /*int*/ +_g.GI /*FutsalID.example.charts._graphinternal*/ .intervalX /*float*/ *_i+(_a-_numberofbars/(double)2)*_bd.BarsWidth /*int*/ ));
...
_rect.setBottom(_g.GI /*FutsalID.example.charts._graphinternal*/ .zeroY /*int*/ );
 }else {
...
_rect.setTop(_g.GI /*FutsalID.example.charts._graphinternal*/ .zeroY /*int*/ );
 };
 }else {
...
_rect.setBottom(_g.GI /*FutsalID.example.charts._graphinternal*/ .originY /*int*/ );
 };
 }else {
 //BA.debugLineNum = 80;BA.debugLine="Rect.Left = G.GI.originX + G.GI.intervalX * i";
_rect.setLeft((int) (_g.GI /*FutsalID.example.charts._graphinternal*/ .originX /*int*/ +_g.GI /*FutsalID.example.charts._graphinternal*/ .intervalX /*float*/ *_i-_bd.BarsWidth /*int*/ /(double)2));
...
_rect.setTop((int) (_rect.getBottom()+_calcpointtopixel(_ba,_point.YArray /*float[]*/ [_a],_g)-_g.GI /*FutsalID.example.charts._graphinternal*/ .originY /*int*/ ));
 };
...
_gi = new FutsalID.example.charts._graphinternal();
 //BA.debugLineNum = 98;BA.debugLine="G.GI = GI";
_g.GI /*FutsalID.example.charts._graphinternal*/  = _gi;
...
_p = (FutsalID.example.charts._linepoint)(_points.Get((int) (1)));
...
_p = (FutsalID.example.charts._linepoint)(_points.Get(_i));
...
public static String  _drawlinechart(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._graph _g,FutsalID.example.charts._linedata _ld,int _backcolor) throws Exception{
FutsalID.example.charts._linepoint _point = null;
float[] _py2 = null;
int _i = 0;
int _a = 0;
...
_point = (FutsalID.example.charts._linepoint)(_ld.Points /*anywheresoftware.b4a.objects.collections.List*/ .Get((int) (0)));
...
_point = (FutsalID.example.charts._linepoint)(_ld.Points /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
...
public static anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _drawpie(anywheresoftware.b4a.BA _ba,FutsalID.example.charts._piedata _pd,int _backcolor,boolean _createlegendbitmap) throws Exception{
int _radius = 0;
int _total = 0;
int _i = 0;
FutsalID.example.charts._pieitem _it = null;
