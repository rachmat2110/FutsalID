...
public class estadio extends Activity implements B4AActivity{
	public static estadio mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "FutsalID.example", "FutsalID.example.estadio");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (estadio).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "FutsalID.example", "FutsalID.example.estadio");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "FutsalID.example.estadio", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (estadio) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (estadio) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (estadio) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public anywheresoftware.b4a.objects.ScrollViewWrapper _sv_estadio = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnlpageestadio = null;
public anywheresoftware.b4a.objects.TabStripViewPager _tsestadio = null;
public anywheresoftware.b4a.objects.ScrollViewWrapper _pnl_svriviewestadio = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnl_riviewestadio = null;
public anywheresoftware.b4a.objects.ListViewWrapper _lv_riviewestadio = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnlgrafikestadio = null;
public static float _val = 0f;
public static float[] _valbuf = null;
public static String _tm = "";
public static String[] _tmbuf = null;
public anywheresoftware.b4a.objects.ButtonWrapper _btnpetaestadio = null;
public anywheresoftware.b4a.objects.MapFragmentWrapper _mapfragment3 = null;
public anywheresoftware.b4a.objects.MapFragmentWrapper.GoogleMapWrapper _gmap = null;
public static String[] _pic = null;
public static int _count = 0;
public anywheresoftware.b4a.objects.PanelWrapper _pnl_insertkomenestadio = null;
public anywheresoftware.b4a.objects.ScrollViewWrapper _sv_insertestadio = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 48;BA.debugLine="Activity.LoadLayout(\"Estadio\")";
mostCurrent._activity.LoadLayout("Estadio",mostCurrent.activityBA);
 //BA.debugLineNum = 49;BA.debugLine="TSEstadio.LoadLayout(\"pnl_SVEstadio\", \"    Inform";
mostCurrent._tsestadio.LoadLayout("pnl_SVEstadio",BA.ObjectToCharSequence("    Informsi Tempat    "));
 //BA.debugLineNum = 50;BA.debugLine="SV_Estadio.Panel.LoadLayout(\"Page1Estadio\")";
mostCurrent._sv_estadio.getPanel().LoadLayout("Page1Estadio",mostCurrent.activityBA);
 //BA.debugLineNum = 51;BA.debugLine="SV_Estadio.Panel.Height = pnlPageEstadio.Height";
mostCurrent._sv_estadio.getPanel().setHeight(mostCurrent._pnlpageestadio.getHeight());
 //BA.debugLineNum = 52;BA.debugLine="SV_Estadio.Panel.Width = pnlPageEstadio.Width";
mostCurrent._sv_estadio.getPanel().setWidth(mostCurrent._pnlpageestadio.getWidth());
 //BA.debugLineNum = 53;BA.debugLine="TSEstadio.LoadLayout(\"pnl_SVRiviewEstadio\", \"   R";
mostCurrent._tsestadio.LoadLayout("pnl_SVRiviewEstadio",BA.ObjectToCharSequence("   Riview   "));
 //BA.debugLineNum = 54;BA.debugLine="pnl_SVriviewEstadio.Panel.LoadLayout(\"layRiviewEs";
mostCurrent._pnl_svriviewestadio.getPanel().LoadLayout("layRiviewEstadio",mostCurrent.activityBA);
 //BA.debugLineNum = 55;BA.debugLine="pnl_SVriviewEstadio.Panel.Height = pnl_RiviewEsta";
mostCurrent._pnl_svriviewestadio.getPanel().setHeight(mostCurrent._pnl_riviewestadio.getHeight());
 //BA.debugLineNum = 56;BA.debugLine="pnl_SVriviewEstadio.Panel.Width = pnl_RiviewEstad";
mostCurrent._pnl_svriviewestadio.getPanel().setWidth(mostCurrent._pnl_riviewestadio.getWidth());
 //BA.debugLineNum = 57;BA.debugLine="TSEstadio.LoadLayout(\"SV_InsertKomenEstadio\", \"";
mostCurrent._tsestadio.LoadLayout("SV_InsertKomenEstadio",BA.ObjectToCharSequence("      Beri Komen     "));
 //BA.debugLineNum = 58;BA.debugLine="SV_InsertEstadio.Panel.LoadLayout(\"layInsertKomen";
mostCurrent._sv_insertestadio.getPanel().LoadLayout("layInsertKomenEstadio",mostCurrent.activityBA);
 //BA.debugLineNum = 59;BA.debugLine="SV_InsertEstadio.Panel.Height = pnl_InsertKomenEs";
mostCurrent._sv_insertestadio.getPanel().setHeight(mostCurrent._pnl_insertkomenestadio.getHeight());
 //BA.debugLineNum = 60;BA.debugLine="SV_InsertEstadio.Panel.Width = pnl_InsertKomenEst";
mostCurrent._sv_insertestadio.getPanel().setWidth(mostCurrent._pnl_insertkomenestadio.getWidth());
 //BA.debugLineNum = 62;BA.debugLine="LV_RiviewEstadio.TwoLinesAndBitmap.Label.TextColo";
mostCurrent._lv_riviewestadio.getTwoLinesAndBitmap().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 63;BA.debugLine="LV_RiviewEstadio.TwoLinesAndBitmap.SecondLabel.He";
mostCurrent._lv_riviewestadio.getTwoLinesAndBitmap().SecondLabel.setHeight((int) (100));
 //BA.debugLineNum = 64;BA.debugLine="LV_RiviewEstadio.TwoLinesAndBitmap.Label.TextSize";
mostCurrent._lv_riviewestadio.getTwoLinesAndBitmap().Label.setTextSize((float) (15));
 //BA.debugLineNum = 65;BA.debugLine="LV_RiviewEstadio.TwoLinesAndBitmap.SecondLabel.Te";
mostCurrent._lv_riviewestadio.getTwoLinesAndBitmap().SecondLabel.setTextSize((float) (13));
 //BA.debugLineNum = 66;BA.debugLine="pic =Array As String (\"user1.png\",\"user2.png\", \"u";
mostCurrent._pic = new String[]{"user1.png","user2.png","user3.png","user4.png","user5.png","user6.png"};
 //BA.debugLineNum = 67;BA.debugLine="GetKomen";
_getkomen();
 //BA.debugLineNum = 68;BA.debugLine="apaja";
_apaja();
...
public ResumableSub_apaja(FutsalID.example.estadio parent) {
this.parent = parent;
}
FutsalID.example.estadio parent;
...
_req = parent.mostCurrent._util._createrequest /*FutsalID.example.dbrequestmanager*/ (mostCurrent.activityBA,estadio.getObject());
 //BA.debugLineNum = 163;BA.debugLine="Dim cmd As DBCommand = util.CreateCommand(\"AvgRat";
_cmd = parent.mostCurrent._util._createcommand /*FutsalID.example.main._dbcommand*/ (mostCurrent.activityBA,"AvgRateEstadio",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
...
anywheresoftware.b4a.keywords.Common.LogImpl("88978472",_j._errormessage /*String*/ ,0);
 if (true) break;
...
public static String  _btnpetaestadio_click() throws Exception{
anywheresoftware.b4a.objects.IntentWrapper _in2 = null;
anywheresoftware.b4j.object.JavaObject _job = null;
 //BA.debugLineNum = 95;BA.debugLine="Sub btnPetaEstadio_Click";
 //BA.debugLineNum = 96;BA.debugLine="ToastMessageShow(\"Opening Maps\",False)";
...
try { //BA.debugLineNum = 98;BA.debugLine="Dim in2 As Intent";
_in2 = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 99;BA.debugLine="in2.Initialize(in2.ACTION_VIEW, \"https://www.goo";
_in2.Initialize(_in2.ACTION_VIEW,"https://www.google.com/maps/dir//Estadio+Futsal,+Jl.+Perjuangan+No.66,+RT.003%2FRW.008,+Marga+Mulya,+Bekasi+Utara,+Bekasi+City,+West+Java+17143/@-6.2314522,107.0004765,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x2e698c1f689ec3b9:0x97b2ba38af7411b6!2m2!1d107.0026652!2d-6.2314575");
 //BA.debugLineNum = 100;BA.debugLine="Dim job As JavaObject = in2";
_job = new anywheresoftware.b4j.object.JavaObject();
_job.setObject((java.lang.Object)(_in2.getObject()));
 //BA.debugLineNum = 101;BA.debugLine="job.RunMethod(\"setPackage\", Array(\"com.google.an";
...
mostCurrent._activity.Finish();
			...
			processBA.setLastException(e10); //BA.debugLineNum = 105;BA.debugLine="Msgbox(\"Google Maps Application is not Found !!\"";
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 256;BA.debugLine="InsertKomen(txtNama.Text,lblRating.Text,txtKomen.";
...
public ResumableSub_GetKomen(FutsalID.example.estadio parent) {
this.parent = parent;
}
FutsalID.example.estadio parent;
FutsalID.example.dbrequestmanager _req = null;
...
_cmd = parent.mostCurrent._util._createcommand /*FutsalID.example.main._dbcommand*/ (mostCurrent.activityBA,"GetCommentEstadio",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
...
anywheresoftware.b4a.keywords.Common.LogImpl("88912908",_j._errormessage /*String*/ ,0);
 if (true) break;
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Private SV_Estadio As ScrollView";
mostCurrent._sv_estadio = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private pnlPageEstadio As Panel";
mostCurrent._pnlpageestadio = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private TSEstadio As TabStrip";
mostCurrent._tsestadio = new anywheresoftware.b4a.objects.TabStripViewPager();
 //BA.debugLineNum = 19;BA.debugLine="Private pnl_SVriviewEstadio As ScrollView";
mostCurrent._pnl_svriviewestadio = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private pnl_RiviewEstadio As Panel";
mostCurrent._pnl_riviewestadio = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private LV_RiviewEstadio As ListView";
mostCurrent._lv_riviewestadio = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private pnlGrafikEstadio As Panel";
mostCurrent._pnlgrafikestadio = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Dim Val As Float";
_val = 0f;
 //BA.debugLineNum = 26;BA.debugLine="Dim ValBuf(14) As Float";
_valbuf = new float[(int) (14)];
;
 //BA.debugLineNum = 27;BA.debugLine="Dim tm,tmbuf(14) As String";
mostCurrent._tm = "";
mostCurrent._tmbuf = new String[(int) (14)];
java.util.Arrays.fill(mostCurrent._tmbuf,"");
 //BA.debugLineNum = 30;BA.debugLine="Private btnPetaEstadio As Button";
mostCurrent._btnpetaestadio = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private MapFragment3 As MapFragment";
mostCurrent._mapfragment3 = new anywheresoftware.b4a.objects.MapFragmentWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Dim gmap As GoogleMap";
...
_count = 0;
 //BA.debugLineNum = 38;BA.debugLine="Private pnl_InsertKomenEstadio As Panel";
mostCurrent._pnl_insertkomenestadio = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Private SV_InsertEstadio As ScrollView";
mostCurrent._sv_insertestadio = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private lblRating As Label";
mostCurrent._lblrating = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 41;BA.debugLine="Private Button1 As Button";
...
_ld.Initialize();
 //BA.debugLineNum = 210;BA.debugLine="LD.Target = pnlGrafikEstadio";
_ld.Target /*anywheresoftware.b4a.objects.PanelWrapper*/  = mostCurrent._pnlgrafikestadio;
...
public ResumableSub_InsertKomen(FutsalID.example.estadio parent,String _nama,int _rating,String _komen) {
this.parent = parent;
this._nama = _nama;
...
_cmd = parent.mostCurrent._util._createcommand /*FutsalID.example.main._dbcommand*/ (mostCurrent.activityBA,"BookingEstadio",new Object[]{(Object)(_nama),(Object)(_rating),(Object)(_komen)});
 //BA.debugLineNum = 125;BA.debugLine="Dim j As HttpJob = util.CreateRequest(Me).Execute";
_j = parent.mostCurrent._util._createrequest /*FutsalID.example.dbrequestmanager*/ (mostCurrent.activityBA,estadio.getObject())._executebatch /*FutsalID.example.httpjob*/ (anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_cmd)}),anywheresoftware.b4a.keywords.Common.Null);
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Rating sudah dimasukkan"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 129;BA.debugLine="LV_RiviewEstadio.Clear";
parent.mostCurrent._lv_riviewestadio.Clear();
...
anywheresoftware.b4a.keywords.Common.LogImpl("88847370",_j._errormessage /*String*/ ,0);
 if (true) break;
...
Object _ret = null;
 //BA.debugLineNum = 245;BA.debugLine="Sub lblRating_Click";
 //BA.debugLineNum = 246;BA.debugLine="Dim nd As NumberDialog";
_nd = new anywheresoftware.b4a.agraham.dialogs.InputDialog.NumberDialog();
 //BA.debugLineNum = 247;BA.debugLine="Dim ret As Object";
_ret = new Object();
 //BA.debugLineNum = 248;BA.debugLine="nd.Digits = 0";
_nd.setDigits((int) (0));
 //BA.debugLineNum = 249;BA.debugLine="nd.Number = 1";
_nd.setNumber((int) (1));
 //BA.debugLineNum = 250;BA.debugLine="nd.Decimal = 0";
_nd.setDecimal((int) (0));
 //BA.debugLineNum = 251;BA.debugLine="ret = nd.Show(\"Rating Untuk Tempat (9/9)\", \"OKE\",";
_ret = (Object)(_nd.Show("Rating Untuk Tempat (9/9)","OKE","","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 252;BA.debugLine="lblRating.Text = nd.Number";
mostCurrent._lblrating.setText(BA.ObjectToCharSequence(_nd.getNumber()));
 //BA.debugLineNum = 253;BA.debugLine="End Sub";
return "";
}
public static String  _mapfragment3_click(anywheresoftware.b4a.objects.MapFragmentWrapper.LatLngWrapper _point) throws Exception{
anywheresoftware.b4a.objects.IntentWrapper _in2 = null;
anywheresoftware.b4j.object.JavaObject _job = null;
 //BA.debugLineNum = 81;BA.debugLine="Sub MapFragment3_Click (Point As LatLng)";
...
mostCurrent._activity.Finish();
			...
			processBA.setLastException(e10); //BA.debugLineNum = 91;BA.debugLine="Msgbox(\"Google Maps Application is not Found !!\"";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Google Maps Application is not Found !!"),BA.ObjectToCharSequence("Warning"),mostCurrent.activityBA);
 };
 //BA.debugLineNum = 93;BA.debugLine="End Sub";
return "";
}
public static void  _mapfragment3_ready() throws Exception{
ResumableSub_MapFragment3_Ready rsub = new ResumableSub_MapFragment3_Ready(null);
rsub.resume(processBA, null);
}
public static class ResumableSub_MapFragment3_Ready extends BA.ResumableSub {
public ResumableSub_MapFragment3_Ready(FutsalID.example.estadio parent) {
this.parent = parent;
}
FutsalID.example.estadio parent;
String _permission = "";
...
//C
this.state = -1;
 //BA.debugLineNum = 110;BA.debugLine="gmap = MapFragment3.GetMap";
parent.mostCurrent._gmap = parent.mostCurrent._mapfragment3.GetMap();
...
parent.mostCurrent._gmap.setMyLocationEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 115;BA.debugLine="Dim m1 As Marker = gmap.AddMarker(-6.231457, 107.";
_m1 = new anywheresoftware.b4a.objects.MapFragmentWrapper.MarkerWrapper();
_m1 = parent.mostCurrent._gmap.AddMarker(-6.231457,107.002675,"Estadio Futsal");
 //BA.debugLineNum = 116;BA.debugLine="m1.Snippet=\"Marga Mulia, Bekasi\"";
_m1.setSnippet("Marga Mulia, Bekasi");
...
_cp = new anywheresoftware.b4a.objects.MapFragmentWrapper.CameraPositionWrapper();
 //BA.debugLineNum = 118;BA.debugLine="cp.Initialize(-6.231457, 107.002675, 17)";
_cp.Initialize(-6.231457,107.002675,(float) (17));
