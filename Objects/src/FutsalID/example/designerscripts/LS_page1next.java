...
views.get("mapfragment5").vw.setTop((int)((views.get("lbllokasi").vw.getTop() + views.get("lbllokasi").vw.getHeight())+(5d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetanext").vw.getTop() + views.get("btnpetanext").vw.getHeight())-(15d * scale)));
views.get("label1").vw.setLeft((int)((50d / 100 * width)-(2d * scale) - (views.get("label1").vw.getWidth() / 2)));
views.get("btnpetanext").vw.setLeft((int)((50d / 100 * width) - (views.get("btnpetanext").vw.getWidth() / 2)));
views.get("btnpetanext").vw.setWidth((int)((49.5d * scale)));
views.get("btnpetanext").vw.setHeight((int)((49.5d * scale)));
views.get("btnpetanext").vw.setTop((int)((views.get("lblisi").vw.getTop() + views.get("lblisi").vw.getHeight())+(15d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetanext").vw.getTop() + views.get("btnpetanext").vw.getHeight())-(10d * scale)));
