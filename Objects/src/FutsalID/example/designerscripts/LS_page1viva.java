...
views.get("mapfragment7").vw.setTop((int)((views.get("lbllokasi").vw.getTop() + views.get("lbllokasi").vw.getHeight())+(5d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetaviva").vw.getTop() + views.get("btnpetaviva").vw.getHeight())-(15d * scale)));
views.get("label1").vw.setLeft((int)((50d / 100 * width)-(2d * scale) - (views.get("label1").vw.getWidth() / 2)));
views.get("btnpetaviva").vw.setLeft((int)((50d / 100 * width) - (views.get("btnpetaviva").vw.getWidth() / 2)));
views.get("btnpetaviva").vw.setWidth((int)((49.5d * scale)));
views.get("btnpetaviva").vw.setHeight((int)((49.5d * scale)));
views.get("btnpetaviva").vw.setTop((int)((views.get("lblisi").vw.getTop() + views.get("lblisi").vw.getHeight())+(15d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetaviva").vw.getTop() + views.get("btnpetaviva").vw.getHeight())-(10d * scale)));
