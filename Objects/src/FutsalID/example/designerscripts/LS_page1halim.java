...
views.get("mapfragment4").vw.setTop((int)((views.get("lbllokasi").vw.getTop() + views.get("lbllokasi").vw.getHeight())+(5d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetahalim").vw.getTop() + views.get("btnpetahalim").vw.getHeight())-(15d * scale)));
views.get("label1").vw.setLeft((int)((50d / 100 * width)-(2d * scale) - (views.get("label1").vw.getWidth() / 2)));
views.get("btnpetahalim").vw.setLeft((int)((50d / 100 * width) - (views.get("btnpetahalim").vw.getWidth() / 2)));
views.get("btnpetahalim").vw.setWidth((int)((49.5d * scale)));
views.get("btnpetahalim").vw.setHeight((int)((49.5d * scale)));
views.get("btnpetahalim").vw.setTop((int)((views.get("lblisi").vw.getTop() + views.get("lblisi").vw.getHeight())+(15d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetahalim").vw.getTop() + views.get("btnpetahalim").vw.getHeight())-(10d * scale)));
