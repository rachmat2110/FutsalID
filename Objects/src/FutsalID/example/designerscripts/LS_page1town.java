...
views.get("mapfragment2").vw.setTop((int)((views.get("lbllokasi").vw.getTop() + views.get("lbllokasi").vw.getHeight())+(5d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetatown").vw.getTop() + views.get("btnpetatown").vw.getHeight())-(15d * scale)));
views.get("label1").vw.setLeft((int)((50d / 100 * width)-(2d * scale) - (views.get("label1").vw.getWidth() / 2)));
views.get("btnpetatown").vw.setLeft((int)((50d / 100 * width) - (views.get("btnpetatown").vw.getWidth() / 2)));
views.get("btnpetatown").vw.setWidth((int)((49.5d * scale)));
views.get("btnpetatown").vw.setHeight((int)((49.5d * scale)));
views.get("btnpetatown").vw.setTop((int)((views.get("lblisi").vw.getTop() + views.get("lblisi").vw.getHeight())+(15d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetatown").vw.getTop() + views.get("btnpetatown").vw.getHeight())-(10d * scale)));
