...
views.get("mapfragment3").vw.setTop((int)((views.get("lbllokasi").vw.getTop() + views.get("lbllokasi").vw.getHeight())+(5d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetaestadio").vw.getTop() + views.get("btnpetaestadio").vw.getHeight())-(15d * scale)));
views.get("label1").vw.setLeft((int)((50d / 100 * width)-(2d * scale) - (views.get("label1").vw.getWidth() / 2)));
views.get("btnpetaestadio").vw.setLeft((int)((50d / 100 * width) - (views.get("btnpetaestadio").vw.getWidth() / 2)));
views.get("btnpetaestadio").vw.setWidth((int)((49.5d * scale)));
views.get("btnpetaestadio").vw.setHeight((int)((49.5d * scale)));
views.get("btnpetaestadio").vw.setTop((int)((views.get("lblisi").vw.getTop() + views.get("lblisi").vw.getHeight())+(15d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetaestadio").vw.getTop() + views.get("btnpetaestadio").vw.getHeight())-(10d * scale)));
