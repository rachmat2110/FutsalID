...
views.get("mapfragment1").vw.setTop((int)((views.get("lbllokasi").vw.getTop() + views.get("lbllokasi").vw.getHeight())+(5d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetaalibaba").vw.getTop() + views.get("btnpetaalibaba").vw.getHeight())-(15d * scale)));
views.get("label1").vw.setLeft((int)((50d / 100 * width)-(2d * scale) - (views.get("label1").vw.getWidth() / 2)));
views.get("btnpetaalibaba").vw.setLeft((int)((50d / 100 * width) - (views.get("btnpetaalibaba").vw.getWidth() / 2)));
views.get("btnpetaalibaba").vw.setWidth((int)((49.5d * scale)));
views.get("btnpetaalibaba").vw.setHeight((int)((49.5d * scale)));
views.get("btnpetaalibaba").vw.setTop((int)((views.get("lblisi").vw.getTop() + views.get("lblisi").vw.getHeight())+(15d * scale)));
views.get("label1").vw.setTop((int)((views.get("btnpetaalibaba").vw.getTop() + views.get("btnpetaalibaba").vw.getHeight())-(10d * scale)));
