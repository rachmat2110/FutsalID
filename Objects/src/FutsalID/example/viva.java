...
public class viva extends Activity implements B4AActivity{
	public static viva mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "FutsalID.example", "FutsalID.example.viva");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (viva).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "FutsalID.example", "FutsalID.example.viva");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "FutsalID.example.viva", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (viva) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (viva) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (viva) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
public anywheresoftware.b4a.objects.TabStripViewPager _tsviva = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnlgrafikviva = null;
public anywheresoftware.b4a.objects.ScrollViewWrapper _sv_viva = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnlpageviva = null;
public anywheresoftware.b4a.objects.ButtonWrapper _btnpetaviva = null;
public anywheresoftware.b4a.objects.MapFragmentWrapper _mapfragment7 = null;
public anywheresoftware.b4a.objects.ScrollViewWrapper _pnl_svriviewviva = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnl_riviewviva = null;
public anywheresoftware.b4a.objects.ListViewWrapper _lv_riviewviva = null;
public anywheresoftware.b4a.objects.ScrollViewWrapper _sv_insertviva = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnl_insertkomenviva = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 48;BA.debugLine="Activity.LoadLayout(\"Viva\")";
mostCurrent._activity.LoadLayout("Viva",mostCurrent.activityBA);
 //BA.debugLineNum = 49;BA.debugLine="TSViva.LoadLayout(\"pnl_SVViva\", \"    Informsi Tem";
mostCurrent._tsviva.LoadLayout("pnl_SVViva",BA.ObjectToCharSequence("    Informsi Tempat    "));
 //BA.debugLineNum = 50;BA.debugLine="SV_Viva.Panel.LoadLayout(\"Page1Viva\")";
mostCurrent._sv_viva.getPanel().LoadLayout("Page1Viva",mostCurrent.activityBA);
 //BA.debugLineNum = 51;BA.debugLine="SV_Viva.Panel.Height = pnlPageViva.Height";
mostCurrent._sv_viva.getPanel().setHeight(mostCurrent._pnlpageviva.getHeight());
 //BA.debugLineNum = 52;BA.debugLine="SV_Viva.Panel.Width = pnlPageViva.Width";
mostCurrent._sv_viva.getPanel().setWidth(mostCurrent._pnlpageviva.getWidth());
 //BA.debugLineNum = 53;BA.debugLine="TSViva.LoadLayout(\"pnl_SVriviewViva\", \"   Riview";
mostCurrent._tsviva.LoadLayout("pnl_SVriviewViva",BA.ObjectToCharSequence("   Riview   "));
 //BA.debugLineNum = 54;BA.debugLine="pnl_SVriviewViva.Panel.LoadLayout(\"layRiviewViva\"";
mostCurrent._pnl_svriviewviva.getPanel().LoadLayout("layRiviewViva",mostCurrent.activityBA);
 //BA.debugLineNum = 55;BA.debugLine="pnl_SVriviewViva.Panel.Height = pnl_RiviewViva.He";
mostCurrent._pnl_svriviewviva.getPanel().setHeight(mostCurrent._pnl_riviewviva.getHeight());
 //BA.debugLineNum = 56;BA.debugLine="pnl_SVriviewViva.Panel.Width = pnl_RiviewViva.Wid";
mostCurrent._pnl_svriviewviva.getPanel().setWidth(mostCurrent._pnl_riviewviva.getWidth());
 //BA.debugLineNum = 57;BA.debugLine="TSViva.LoadLayout(\"SV_InsertKomenViva\", \"      Be";
mostCurrent._tsviva.LoadLayout("SV_InsertKomenViva",BA.ObjectToCharSequence("      Beri Komen     "));
 //BA.debugLineNum = 58;BA.debugLine="SV_InsertViva.Panel.LoadLayout(\"layInsertKomenViv";
mostCurrent._sv_insertviva.getPanel().LoadLayout("layInsertKomenViva",mostCurrent.activityBA);
 //BA.debugLineNum = 59;BA.debugLine="SV_InsertViva.Panel.Height = pnl_InsertKomenViva.";
mostCurrent._sv_insertviva.getPanel().setHeight(mostCurrent._pnl_insertkomenviva.getHeight());
 //BA.debugLineNum = 60;BA.debugLine="SV_InsertViva.Panel.Width = pnl_InsertKomenViva.W";
mostCurrent._sv_insertviva.getPanel().setWidth(mostCurrent._pnl_insertkomenviva.getWidth());
 //BA.debugLineNum = 61;BA.debugLine="LV_RiviewViva.TwoLinesAndBitmap.Label.TextColor =";
mostCurrent._lv_riviewviva.getTwoLinesAndBitmap().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 62;BA.debugLine="LV_RiviewViva.TwoLinesAndBitmap.SecondLabel.Heigh";
mostCurrent._lv_riviewviva.getTwoLinesAndBitmap().SecondLabel.setHeight((int) (100));
 //BA.debugLineNum = 63;BA.debugLine="LV_RiviewViva.TwoLinesAndBitmap.Label.TextSize =";
mostCurrent._lv_riviewviva.getTwoLinesAndBitmap().Label.setTextSize((float) (15));
 //BA.debugLineNum = 64;BA.debugLine="LV_RiviewViva.TwoLinesAndBitmap.SecondLabel.TextS";
mostCurrent._lv_riviewviva.getTwoLinesAndBitmap().SecondLabel.setTextSize((float) (13));
...
public ResumableSub_apaja(FutsalID.example.viva parent) {
this.parent = parent;
}
FutsalID.example.viva parent;
...
_req = parent.mostCurrent._util._createrequest /*FutsalID.example.dbrequestmanager*/ (mostCurrent.activityBA,viva.getObject());
 //BA.debugLineNum = 158;BA.debugLine="Dim cmd As DBCommand = util.CreateCommand(\"AvgRat";
_cmd = parent.mostCurrent._util._createcommand /*FutsalID.example.main._dbcommand*/ (mostCurrent.activityBA,"AvgRateViva",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
...
anywheresoftware.b4a.keywords.Common.LogImpl("814549032",_j._errormessage /*String*/ ,0);
 if (true) break;
...
public static String  _btnpetaviva_click() throws Exception{
anywheresoftware.b4a.objects.IntentWrapper _in2 = null;
anywheresoftware.b4j.object.JavaObject _job = null;
 //BA.debugLineNum = 93;BA.debugLine="Sub btnPetaViva_Click";
...
_in2.Initialize(_in2.ACTION_VIEW,"https://www.google.com/maps/dir//Viva+Futsal,+Jalan+Perjuangan,+RT.003%2FRW.009,+Marga+Mulya,+Bekasi+City,+West+Java/@-6.2253435,106.9733943,13z/data=!4m8!4m7!1m0!1m5!1m1!1s0x2e698ea73e5a1353:0xee73c78fd525ba3b!2m2!1d107.008414!2d-6.22543");
...
public ResumableSub_GetKomen(FutsalID.example.viva parent) {
this.parent = parent;
}
FutsalID.example.viva parent;
FutsalID.example.dbrequestmanager _req = null;
...
_cmd = parent.mostCurrent._util._createcommand /*FutsalID.example.main._dbcommand*/ (mostCurrent.activityBA,"GetCommentViva",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
...
parent._count = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),(int) (5));
 //BA.debugLineNum = 146;BA.debugLine="LV_RiviewViva.AddTwoLinesAndBitmap(row(0) ,row(";
parent.mostCurrent._lv_riviewviva.AddTwoLinesAndBitmap(BA.ObjectToCharSequence(_row[(int) (0)]),BA.ObjectToCharSequence(_row[(int) (2)]),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),parent.mostCurrent._pic[parent._count]).getObject()));
 if (true) break;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("814483468",_j._errormessage /*String*/ ,0);
 if (true) break;
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 18;BA.debugLine="Dim Val As Float";
_val = 0f;
 //BA.debugLineNum = 19;BA.debugLine="Dim ValBuf(14) As Float";
_valbuf = new float[(int) (14)];
;
 //BA.debugLineNum = 20;BA.debugLine="Dim tm,tmbuf(14) As String";
mostCurrent._tm = "";
mostCurrent._tmbuf = new String[(int) (14)];
java.util.Arrays.fill(mostCurrent._tmbuf,"");
 //BA.debugLineNum = 23;BA.debugLine="Dim gmap As GoogleMap";
mostCurrent._gmap = new anywheresoftware.b4a.objects.MapFragmentWrapper.GoogleMapWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim pic() As String";
mostCurrent._pic = new String[(int) (0)];
java.util.Arrays.fill(mostCurrent._pic,"");
 //BA.debugLineNum = 27;BA.debugLine="Dim count As Int";
_count = 0;
 //BA.debugLineNum = 29;BA.debugLine="Private TSViva As TabStrip";
mostCurrent._tsviva = new anywheresoftware.b4a.objects.TabStripViewPager();
 //BA.debugLineNum = 30;BA.debugLine="Private pnlGrafikViva As Panel";
mostCurrent._pnlgrafikviva = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private SV_Viva As ScrollView";
mostCurrent._sv_viva = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Private pnlPageViva As Panel";
mostCurrent._pnlpageviva = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Private btnPetaViva As Button";
mostCurrent._btnpetaviva = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Private MapFragment7 As MapFragment";
mostCurrent._mapfragment7 = new anywheresoftware.b4a.objects.MapFragmentWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Private pnl_SVriviewViva As ScrollView";
mostCurrent._pnl_svriviewviva = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Private pnl_RiviewViva As Panel";
mostCurrent._pnl_riviewviva = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Private LV_RiviewViva As ListView";
mostCurrent._lv_riviewviva = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Private SV_InsertViva As ScrollView";
mostCurrent._sv_insertviva = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Private pnl_InsertKomenViva As Panel";
mostCurrent._pnl_insertkomenviva = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private txtKomen As EditText";
mostCurrent._txtkomen = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 41;BA.debugLine="Private txtNama As EditText";
...
_ld.Initialize();
 //BA.debugLineNum = 205;BA.debugLine="LD.Target = pnlGrafikViva";
_ld.Target /*anywheresoftware.b4a.objects.PanelWrapper*/  = mostCurrent._pnlgrafikviva;
...
public ResumableSub_InsertKomen(FutsalID.example.viva parent,String _nama,int _rating,String _komen) {
this.parent = parent;
this._nama = _nama;
...
_cmd = parent.mostCurrent._util._createcommand /*FutsalID.example.main._dbcommand*/ (mostCurrent.activityBA,"BookingViva",new Object[]{(Object)(_nama),(Object)(_rating),(Object)(_komen)});
 //BA.debugLineNum = 121;BA.debugLine="Dim j As HttpJob = util.CreateRequest(Me).Execute";
_j = parent.mostCurrent._util._createrequest /*FutsalID.example.dbrequestmanager*/ (mostCurrent.activityBA,viva.getObject())._executebatch /*FutsalID.example.httpjob*/ (anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_cmd)}),anywheresoftware.b4a.keywords.Common.Null);
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Rating sudah dimasukkan"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 125;BA.debugLine="LV_RiviewViva.Clear";
parent.mostCurrent._lv_riviewviva.Clear();
...
anywheresoftware.b4a.keywords.Common.LogImpl("814417930",_j._errormessage /*String*/ ,0);
 if (true) break;
...
public static String  _mapfragment7_click(anywheresoftware.b4a.objects.MapFragmentWrapper.LatLngWrapper _point) throws Exception{
anywheresoftware.b4a.objects.IntentWrapper _in2 = null;
anywheresoftware.b4j.object.JavaObject _job = null;
 //BA.debugLineNum = 80;BA.debugLine="Sub MapFragment7_Click (Point As LatLng)";
...
public static void  _mapfragment7_ready() throws Exception{
ResumableSub_MapFragment7_Ready rsub = new ResumableSub_MapFragment7_Ready(null);
rsub.resume(processBA, null);
}
public static class ResumableSub_MapFragment7_Ready extends BA.ResumableSub {
public ResumableSub_MapFragment7_Ready(FutsalID.example.viva parent) {
this.parent = parent;
}
FutsalID.example.viva parent;
String _permission = "";
...
//C
this.state = -1;
 //BA.debugLineNum = 107;BA.debugLine="gmap = MapFragment7.GetMap";
parent.mostCurrent._gmap = parent.mostCurrent._mapfragment7.GetMap();
...
parent.mostCurrent._gmap.setMyLocationEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 112;BA.debugLine="Dim m1 As Marker = gmap.AddMarker(-6.22543, 107.0";
_m1 = new anywheresoftware.b4a.objects.MapFragmentWrapper.MarkerWrapper();
_m1 = parent.mostCurrent._gmap.AddMarker(-6.22543,107.00841,"Viva Futsal");
 //BA.debugLineNum = 113;BA.debugLine="m1.Snippet=\"Marga Mulya, Bekasi\"";
_m1.setSnippet("Marga Mulya, Bekasi");
...
_cp = new anywheresoftware.b4a.objects.MapFragmentWrapper.CameraPositionWrapper();
 //BA.debugLineNum = 115;BA.debugLine="cp.Initialize(-6.22543, 107.00841, 19)";
_cp.Initialize(-6.22543,107.00841,(float) (19));
